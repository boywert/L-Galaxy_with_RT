			...
			if(strcmp(MCMC_PAR[i].Type,"Physical")==0)
			{
				if(Sample_Physical_Parameters==1)
				{
					if(Time_Dependant_PhysPar==1)
						for(snap=0;snap<NOUT;snap++)
							fprintf(fmcmc," %0.4g", log10(MCMC_PAR[i].Value[snap]));
					else
						fprintf(fmcmc," %0.4g", log10(MCMC_PAR[i].Value[0]));
				}
			}
			...
			if(MCMC_PAR[i].Sampling_Switch==1)
			{
				if (strcmp(MCMC_PAR[i].Type,"Physical")==0)
				{
					if(Sample_Physical_Parameters==1)
					{
						if(Time_Dependant_PhysPar==1)
							for(snap=0;snap<NOUT;snap++)
								printf("%0.4g ",MCMC_PAR[i].PropValue[snap]);
						else
							printf("%0.4g ",MCMC_PAR[i].PropValue[0]);
					}
				}
				else if (strcmp(MCMC_PAR[i].Type,"Cosmological")==0)
				{
			...
			if(MCMC_PAR[i].Sampling_Switch==1)
			{
				if (strcmp(MCMC_PAR[i].Type,"Physical")==0)
				{
					if(Sample_Physical_Parameters==1)
					{
						if(Time_Dependant_PhysPar==1)
							for(snap=0;snap<NOUT;snap++)
								printf("%0.4g ",log10(MCMC_PAR[i].PropValue[snap]));
						else
							printf("%0.4g ",log10(MCMC_PAR[i].PropValue[0]));
					}
				}
				else if (strcmp(MCMC_PAR[i].Type,"Cosmological")==0)
				{
