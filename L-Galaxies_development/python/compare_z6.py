...
config = {}
model_names = ["okamoto","sullivan","noreionization","patchy_I","patchy_II"]
model_labels = ["Okamoto et al. (2008)","Sullivan et al. (in prep)","No Reionization","Patchy Reionization I","Patchy Reionization II"]
model_paths = ["/mnt/lustre/scratch/cs390/47Mpc/outputs/okamoto/","/mnt/lustre/scratch/cs390/47Mpc/outputs/sullivan/","/mnt/lustre/scratch/cs390/47Mpc/outputs/no_reionization/","/mnt/lustre/scratch/cs390/47Mpc/outputs/patchy_reionization_I/","/mnt/lustre/scratch/cs390/47Mpc/outputs/patchy_reionization_II/"]
model_plot_patterns = ['r--','c--','b--','g--','m--']
